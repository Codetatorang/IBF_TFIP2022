package ibf2022.tfip.ssf.day14workshopRedisIntroduction.model;
...
public class Contact implements Serializable{
    ...
    @Max(value = 120, message = "Must be below 120 years old")
    private int age;
    ...
    public Contact(String name, String email, String phoneNumber, String id, LocalDate dateOfBirth, int age) {
        this.name = name;
        this.email = email;
        this.phoneNumber = phoneNumber;
        this.id = id;
